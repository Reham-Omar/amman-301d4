...
function displayPics(){
  ...
  // this part was the error   console.log(rando);   we cant  console outside the scope beacuse const is a block scoped  and it declared the rando inside the function .
